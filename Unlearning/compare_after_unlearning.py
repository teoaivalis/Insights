...
def process_folders(reference_folder, before_folder, after_folder, model):
    ...
    for subfolder in os.listdir(before_folder):
        ...
        if os.path.exists(reference_image_path) and os.path.exists(folder_path_1) and os.path.exists(folder_path_2):
            ...
            std_similarity_1 = np.std(similarity_scores_1)
            std_similarity_2 = np.std(similarity_scores_2)

            data.append([subfolder,
                         mean_similarity_1, min_similarity_1, max_similarity_1, std_similarity_1,
                         mean_similarity_2, min_similarity_2, max_similarity_2, std_similarity_2])
...
with open(csv_file, 'w', newline='') as file:
    ...
    writer.writerow(['Folder', 'Mean_1', 'Min_1', 'Max_1', 'Std_1', 'Mean_2', 'Min_2', 'Max_2', 'Std_2'])
